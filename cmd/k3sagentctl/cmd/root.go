...
var rootCmd = &cobra.Command{
	Use:   "k3sagentctl",
	Short: "k3sagentctl manages agents on k3sd, the k3s management daemon",
	Long: `k3sagentctl manages agents on k3sd, the k3s management daemon.

Find more information at:
https://pojntfx.github.io/k3sd/`,
	PersistentPreRun: func(cmd *cobra.Command, args []string) {
		viper.SetEnvPrefix("k3sagent")
